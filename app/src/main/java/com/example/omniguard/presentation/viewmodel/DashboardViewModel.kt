...
import com.example.omniguard.domain.usecase.CalculateSecurityScoreUseCase
...
class DashboardViewModel @Inject constructor(
    ...
    private data class DataPack(
        ...
        val storage: com.example.omniguard.data.repository.StorageAnalysis,
        val battery: com.example.omniguard.data.repository.BatteryInfo
    )
